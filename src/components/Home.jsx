    ...
    <>
      ...
      <div className="flex items-center flex-col w-full min-h-[100dvh] lg:min-h-screen md:min-h-screen p-4 sm:px-8 md:px-16 pt-10 sm:pt-16 md:pt-28 font-Montserrat cursor-none overflow-hidden">
        ...
        <img
          src={portrait}
          alt="Portrait"
          className="w-68 sm:w-64 md:w-80 lg:w-96 xl:w-[28rem] mt-4 sm:mt-24 sm:absolute sm:-z-10"
        />

        {/* Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 -mt-4 sm:mt-24 text-sm w-full sm:w-auto items-center">
          <button
            onClick={() =>
